...
**Project**: fuzzy-bear-battlefield 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: https://github.com/baphometsblade/Terrible_Teddies_Battle_of_the_Bear-ristocrats.git 
...
```sh
git clone https://github.com/GPT-Engineer-App/fuzzy-bear-battlefield.git
cd fuzzy-bear-battlefield
npm i
